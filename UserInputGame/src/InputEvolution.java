...
public class InputEvolution {
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome to .... College, Are you ready to begin your semester? (yes or no)");
	...
	public static void intro(){
		...
		userInput.nextLine();
		System.out.println("Life here is simple. If you would like to do anything, simply type it into your command book.\n"
